![image](https://github.com/user-attachments/assets/fc362c76-594d-4bc8-8193-be164d42150b)## Описание 2 лабораторной работы
...
________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________
Описание 5 лабораторной работы 
1.Добавил POST метод для работы со списком параметров для bulk операций, организовал работу сервиса используя Java 8 .
2. Покрытие Unit-тестами у меня в проекте более 80% (бизнес-логика).
